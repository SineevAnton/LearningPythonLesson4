# Two files are given, each of which contains a record of the polynomial.
# The task is to form a file containing the sum of polynomials.
...
k1 = int(input("Enter the natural degree for the first polynomial k = "))
k2 = int(input("Enter the natural degree for the second polynomial k = "))
koef1 = create_mn(k1)
koef2 = create_mn(k2)
